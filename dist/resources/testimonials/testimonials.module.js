...
const testimonial_provider_1 = require("./providers/testimonial.provider");
...
TestimonialsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [testimonials_service_1.TestimonialsService, ...testimonial_provider_1.testimonialProviders, app_service_1.AppService]
    })
], TestimonialsModule);
